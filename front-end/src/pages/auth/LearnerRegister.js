...
const LearnerRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await authAPI.registerLearner(payload);
  ...
  return (
    <div className="bg-dark min-vh-100 d-flex align-items-center py-4">
      <Container>
            ...
            <Card className="shadow border-0">
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  ...
                  <h3 className="mt-2 fw-bold">Student Registration</h3>
                </div>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  {formData.studentType === "internal" && (
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control type="text" name="branchName" placeholder="Enter branch" value={formData.branchName} onChange={handleChange} required />
                    </Form.Group>
                  )}
                ...
                <div className="text-center mt-3">
                  <Link to="/learner/login" className="text-decoration-none">Already have an account? Login</Link>
                </div>
